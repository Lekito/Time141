                ...
                <div className="lg:min-h-screen lg:flex lg:items-center p-10 lg:p-20 xl:p-30  ">
                    <div className="flex-grow bg-white py-5 ">
                        <div className="sm:flex sm:items-center flex flex-col">
                            ...
                            <div>
                                <h1 className="text-center p-2 text-xl font-semibold text-gray-900 py-10">Celular</h1>
                            </div>
                            <div className="sm:ml-4 sm:text-left text-center py-5">
                                <form className="flex w-full mt-8">
                                    <input type="phone" placeholder="(99) 99999-9999" className="flex-1 w-full text-gray-700 bg-gray-200 rounded-md hover:bg-white border border-gray-200 outline-none focus:bg-white py-2 px-4">
                                    </input>
                                </form>
                            </div>
                        </div>
